...
# Step 5. Create folds of your data, then run the training once to inspect results
...
# Step 6. Run the final prediction on the test data and re-attach file names. 
df.test <- test.df
df.pred<-predict(df.model, df.test)
